...
export const APP_VERSION = "2.0.0-beta.6";
export const APP_BASELINE = "V2 beta · professional illustrations and real photographs · carries everything up to 1.14.0";
