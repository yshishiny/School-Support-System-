...
export const APP_VERSION = "2.0.0-beta.9";
export const APP_BASELINE = "V2 beta · shared chores on a rota, prayers claimed from a sheet · carries everything up to 1.14.0";
