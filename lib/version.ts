...
export const APP_VERSION = "2.0.0-beta.22";
export const APP_BASELINE = "V2 beta \u00b7 lessons open at once and every page fits a phone \u00b7 carries everything up to 1.15.0";
