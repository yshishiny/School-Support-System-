...
export const APP_VERSION = "2.0.0-beta.7";
export const APP_BASELINE = "V2 beta · exact geometry, a laser pointer and a presenter who keeps talking · carries everything up to 1.14.0";
