...
export const DEMO_EN: LessonScript = {
  ...
  beats: [
    ...
    { kind: "explain", say: "Written as a formula it looks like this. The letters a and b are the numerators, and c is the shared denominator. Only the top changes.", show: { type: "formula", content: "a⁄c + b⁄c = (a + b)⁄c", cues: null }, check: null, gesture: "write", mood: "neutral" },
...
export const DEMO_AR: LessonScript = {
  ...
  beats: [
    ...
    { kind: "recap", say: "والآن الحقيقة بلا حكاية: مقام واحد يعني نجمع البسطين ونبقي المقام. أحسنت.", show: { type: "formula", content: "أ⁄ج + ب⁄ج = (أ + ب)⁄ج", cues: null }, check: null, gesture: "celebrate", mood: "encourage" },
  ],
  quiz: [
