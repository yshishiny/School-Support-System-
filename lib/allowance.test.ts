...
const base = {
  kpis: mergeKpis([{ code: "classlog", enabled: false }, { code: "checkpoint", enabled: false }, { code: "homework", enabled: false }, { code: "grades", enabled: false }]), // these have their own tests below
  start: "2026-09-11",
  end: "2026-09-17",
...
describe("scoreWeek", () => {
  ...
  it("scores homework by due date and the monthly grades sheet from the 21st", () => {
    const kpis = mergeKpis([{ code: "classlog", enabled: false }, { code: "checkpoint", enabled: false }]);
