...
const base: WeekResult = {
  ...
  results: [
    { code: "dish", label: "Cleared his dish and his space", emoji: "🍽️", weight: 20, fraction: 1, earned: 20, detail: "no ✗ so far" },
    { code: "manners", label: "Manners: respectful, no shouting", emoji: "🤝", weight: 20, fraction: 0.75, earned: 15, detail: "1 day marked ✗" },
    { code: "classlog", label: "Every class logged: what he took, homework yes/no", emoji: "📖", weight: 15, fraction: 0.5, earned: 7.5, detail: "3 of 6 classes logged" },
    { code: "prayers", label: "Prayers logged, 4 of 5 most days", emoji: "🕌", weight: 15, fraction: 0.66, earned: 9.9, detail: "2 of 4 days with 4+ prayers" },
    { code: "snap:bed", label: "Snap: Bed made", emoji: "🛏️", weight: 10, fraction: 0.75, earned: 7.5, detail: "3 of 4 days snapped" },
    { code: "checkpoint", label: "Weekly checkpoint attempted", emoji: "🎯", weight: 10, fraction: 1, earned: 10, detail: "none this week" },
  ],
};
