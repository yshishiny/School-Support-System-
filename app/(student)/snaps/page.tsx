...
export default async function SnapsPage() {
  ...
  return (
    <main className="space-y-3">
      ...
      {isRater && (toCheck ?? 0) > 0 && (
        <Link href="/me?tab=family" className="card !py-2.5 flex items-center gap-3 border-2 border-accent">
          <span className="text-2xl">🧐</span>
          <div className="flex-1 min-w-0">
            <div className="font-bold text-sm">Check your brothers&apos; snaps</div>
            <div className="text-xs muted">{toCheck} waiting for your tick</div>
          </div>
