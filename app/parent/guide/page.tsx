...
const STEPS: { emoji: string; title: string; body: string; href: string; cta: string }[] = [
  ...
  { emoji: "🧠", title: "Everything about one child", body: "Open a child and you get all of him on one page: how he is doing across every discipline, his mastery per topic, exam estimates, the coach's analysis, his manners, his chores, his prayers and his money. Every heading opens the detail behind it.", href: "/parent/trace", cta: "Open a child" },
  { emoji: "💵", title: "Allowance through the basics", body: "Turn it on, keep the KPI list, and tap ✓ or ✗ for dish, manners and phone once a day on Home. The app counts prayers, check-ins, quiz attempts and coach check-ins itself, shows each boy a live meter all week, and closes the week the morning after pay day in graded bands (90+ full, 70+ most, 50+ some). Consequences are listed there too: never schoolwork, always a way back.", href: "/parent/allowance", cta: "Allowance" },
