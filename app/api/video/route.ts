...
export async function POST(req: Request) {
  ...
  let body: { text?: string; character?: string; language?: string; voice?: string | null; create?: boolean };
  ...
  const answer = await requestClip({ characterId: c.id, voice, text: body.text, create: body.create !== false });
