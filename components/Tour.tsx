...
export function Tour({ firstName, mascot, stickers, alreadySeen }: { firstName: string; mascot: string; stickers: string[]; alreadySeen: boolean }) {
  ...
  const slides: Slide[] = [
    ...
    { emoji: "🎁", title: "Points, rewards and allowance", points: ["Your weekly allowance is earned by the basics: dish, manners, phone parked, prayers, check-ins, planned quizzes attempted. The meter on your home page shows what you are heading for and what to fix; 90+ pays it all.","Check-in +10, each class note +2, prayers up to +25, practice up to +60 a day, planned quiz on the day +5.", "Streaks pay the most: 3 days +20, 7 days +50, 14 days +100, 30 days +250.", "Rewards: cash or things your parents set up. Redeem in the Rewards tab; they approve."] },
